<%@ Page Language="C#" MasterPageFile="../Game/게임관리.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="딜비내역.aspx.cs" Inherits="게임관리_딜비목록" Title="코리아 게임 관리자페이지" %>
...
<script type="text/javascript">
    ...
    <asp:GridView ID="grdList" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="dealmoney" HeaderText="딜러비" SortExpression="dealmoney" DataFormatString="{0:N0}">

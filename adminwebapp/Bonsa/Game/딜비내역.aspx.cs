...
public partial class 게임관리_딜비목록 : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        KEY_AUTOREFRESH = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:자동갱신:";
        KEY_CACHEINFOS = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:검색정보들:";
        KEY_CACHEQUERY = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:검색질문식:";
        KEY_CACHESELINF = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:선택된정보:";
        KEY_CACHESORT = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:정돈항:";
        KEY_CACHESORTDIRECTION = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:정돈방향:";
        KEY_CACHEFILTER = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:검색인자들:";
        KEY_CACHECURPAGE = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:현재페지위치:";
        KEY_CACHEFIRSTDATE = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:첫날자:";
        KEY_CACHELASTDATE = "CACHE:NEWBACARA:본사:업체페지:게임관리:딜비목록:끝날자:";
    ...
    public void BindDataSource()
    {
        ...
        string strQuery = "SELECT userid, nickname, bonsa, bubonsa, chongpan, maejang, sum(dealmoney) as dealmoney, regdate FROM tbl_bethist ";
    ...
    void GridDataBind()
    {
        ...
        if (src != null && (src.Tables[0] != null) && (src.Tables[0].Rows != null) && src.Tables[0].Rows.Count > 0)
        {
            ...
            {
                moneySum += Convert.ToInt64(src.Tables[0].Rows[i]["dealmoney"]);
            }
        }
        else
        {

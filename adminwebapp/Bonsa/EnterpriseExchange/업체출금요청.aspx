<%@ Page Language="C#" MasterPageFile="../EnterpriseExchange/업체입출금관리.master" AutoEventWireup="true" CodeFile="업체출금요청.aspx.cs" Inherits="업체입출금관리_업체출금요청" Title="코리아 게임 관리자페이지" %>
    ...
    <asp:GridView ID="grdList" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkEdit" OnClientClick="return confirm('승인하시겠습니까?');" runat="server"
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkDelete" OnClientClick="return confirm('취소하시겠습니까?');" runat="server"

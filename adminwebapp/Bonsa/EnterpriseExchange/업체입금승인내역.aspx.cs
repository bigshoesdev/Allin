...
public partial class 업체입출금관리_업체입금승인내역 : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        KEY_AUTOREFRESH = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:자동갱신:";
        KEY_CACHEINFOS = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:검색정보들:";
        KEY_CACHEQUERY = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:검색질문식:";
        KEY_CACHESELINF = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:선택된정보:";
        KEY_CACHESORT = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:정돈항:";
        KEY_CACHESORTDIRECTION = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:정돈방향:";
        KEY_CACHEFILTER = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:검색인자들:";
        KEY_CACHECURPAGE = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:현재페지위치:";
        KEY_CACHEFIRSTDATE = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:첫날자:";
        KEY_CACHELASTDATE = "CACHE:NEWBACARA:본사:업체입출금관리:업체입금승인내역:끝날자:";
    ...
    public void BindDataSource()
    {
        ...
        string strQuery = "SELECT * FROM TBL_ECharge JOIN TBL_Enterprise ON TBL_Enterprise.ID = TBL_ECharge.EnterpriseID WHERE TBL_ECharge.state>0  AND TBL_ECharge.RegDate >= @StartDate AND TBL_ECharge.RegDate <= @EndDate";// AND TBL_Enterprise.ParentID=" + 인증회원번호;3

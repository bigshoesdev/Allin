<%@ Page Language="C#" MasterPageFile="../EnterpriseExchange/업체입출금관리.master" AutoEventWireup="true" CodeFile="업체입금승인내역.aspx.cs" Inherits="업체입출금관리_업체입금승인내역" Title="코리아 게임 관리자페이지" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" Runat="Server">
    ...
    <div class='PageToolBar'>
        <table width="100%" border="0" cellpadding="7" cellspacing="1">
            <tr valign="middle">
                ...
                <td class="srcTit" nowrap>
                    &nbsp;<img src="../../Images/ico_sqr02.gif" width="3" height="3" /> &nbsp;
                    날자:
    ...
    <asp:GridView ID="grdList" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="요청형태" SortExpression="state">
                <ItemTemplate>
                    <asp:Label ID="lblReqType" runat="server" CausesValidation="False"
                        Text='<%# Eval("chargetype").ToString() == "1" ? "쿠폰입금" : "현금입금" %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle CssClass="NoticeGridItem" HorizontalAlign="Center" Width="100px" Wrap=false />
            </asp:TemplateField>

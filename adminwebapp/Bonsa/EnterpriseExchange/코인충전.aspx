<%@ Page Language="C#" MasterPageFile="업체입출금관리.master" AutoEventWireup="true" CodeFile="코인충전.aspx.cs"
    Inherits="업체입출금관리_코인충전" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceHolder" runat="Server">
    ...
    <table style="border-right: #cacaca 1px solid; font-size: 12px; border-left: #cacaca 1px solid;
        ...
        <tr>
            ...
            <td class="clsFieldName" align="right" width="100px" nowrap>
                <asp:CustomValidator ID="cvWithdrawResult" Visible="false" runat="server" Display="Dynamic"
                    ValidationGroup="withdraw"></asp:CustomValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="tbxWithdrawMoney" Display="Dynamic"
                    ErrorMessage="수값을 입력하세요" Operator="DataTypeCheck" SetFocusOnError="True" Type="Integer"
                    ValidationGroup="withdraw">*</asp:CompareValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbxWithdrawMoney"
                    ErrorMessage="환전할 금액을 입력하세요." ValidationGroup="withdraw">*</asp:RequiredFieldValidator>
                환전머니:
            </td>
            <td class="clsItemLabel" nowrap align="left" width="" width="400px" nowrap>
                &nbsp;
                <asp:TextBox ID="tbxWithdrawMoney" runat="server" CssClass="clsEditableFieldValueE" ValidationGroup="userreg"
                    Width="70px"></asp:TextBox>원&nbsp;&nbsp;
            </td>
            <td class="clsItemLabel">
                <asp:Button ID="btnWithdraw" runat="server" CssClass="clsButton" Text="요청하기" OnClick="btnWithdraw_Click"
                    ValidationGroup="withdraw" />
            </td>
        </tr>
        <tr>
            <td width=100% nowrap colspan=10>
                ...
                <asp:ValidationSummary ID="vsWithdrawError" runat="server" ValidationGroup="withdraw" DisplayMode="SingleParagraph" />
            </td>
        </tr>
    </table>
    <br />
    ...
    <asp:Panel ID="pnlWithdrawList" runat="server">
        <asp:GridView ID="grdWithdrawList" runat="server" AllowPaging="True" AllowSorting="True"
            AutoGenerateColumns="False" CellPadding="3" CellSpacing="1" EmptyDataText="등록된 자료가 없습니다."
            ForeColor="#333333" GridLines="None" HorizontalAlign="Center" OnPageIndexChanging="grdWithdrawLisTBL_PageIndexChanging"
            OnRowDataBound="grdWithdrawLisTBL_RowDataBound" OnRowDeleting="grdWithdrawLisTBL_RowDeleting" OnSorting="grdWithdrawLisTBL_Sorting"
            Width="100%" DataKeyNames="ID" OnRowEditing="grdWithdrawLisTBL_RowEditing" Font-Size="10pt">
            <PagerSettings Mode="NumericFirstLast" />
            <Columns>
                <asp:TemplateField HeaderText="번호" SortExpression="ID">
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="Money" HeaderText="요청캐롯" SortExpression="Money" DataFormatString="{0:N0}">
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
                <asp:BoundField DataField="bankname" HeaderText="은행명" SortExpression="bankname">
                    <ItemStyle HorizontalAlign="center" />
        ...
        <asp:Panel ID="Panel2" runat="server" CssClass="clsControlBar">
            <asp:Button ID="Button1" runat="server" CssClass="clsButton" Text="목록수정" OnClick="btnRefresh_Click" />
        </asp:Panel>
    </asp:Panel>
    <br />

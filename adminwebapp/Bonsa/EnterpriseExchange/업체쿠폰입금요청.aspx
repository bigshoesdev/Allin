<%@ Page Language="C#" MasterPageFile="../EnterpriseExchange/업체입출금관리.master" AutoEventWireup="true" CodeFile="업체쿠폰입금요청.aspx.cs" Inherits="업체입출금관리_업체쿠폰입금요청" Title="코리아 게임 관리자페이지" %>

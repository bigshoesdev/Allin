...
public partial class MngMember_usercharge : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //{
            ...
            {
                rvMoney.ErrorMessage = "충전해줄수 있는 기프트는 " + 인증회원.Tables[0].Rows[0]["money"].ToString() + "까지입니다.";
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // 2. 입금체계에 충전리력을 남긴다.
            string admin = "운영자기프트충전";
            string name = 인증회원.Tables[0].Rows[0]["name"].ToString();
            string memo = "";
            strQuery = "INSERT INTO TBL_Charge(UserID, couponname, Name, Money, Status) ";

<%@ Page Language="C#" MasterPageFile="../User/회원관리.master" AutoEventWireup="true" CodeFile="부본사등록.aspx.cs" Inherits="회원관리_부본사상세정보" Title="코리아 게임 관리자페이지" %>
        ...
        <tr>
            <td class="clsFieldName">
                <asp:RangeValidator ID="rvClassPercent" runat="server" 
                    ...
                    ErrorMessage="부본사지분율은 0부터 100사이의 값이어야 합니다." MaximumValue="100" MinimumValue="0" 
                    SetFocusOnError="True" Type="Double" ValidationGroup="userreg">*</asp:RangeValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                    ControlToValidate="tbxClassPercent" Display="Dynamic" ErrorMessage="부본사지분율은 수값이여야 합니다." 
                    Operator="DataTypeCheck" Type="Double" SetFocusOnError="True" 
                    ValidationGroup="userreg">*</asp:CompareValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    ControlToValidate="tbxClassPercent" Display="Dynamic" ErrorMessage="부본사지분율을 입력하세요" 
                    SetFocusOnError="True" ValidationGroup="userreg">*</asp:RequiredFieldValidator>
                부본사 지분율</td>
            <td class="clsFieldValue">

...
public partial class 회원관리_총판목록 : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        KEY_AUTOREFRESH = "CACHE:NEWBACARA:본사:총판관리:총판목록:자동갱신:";
        KEY_CACHEINFOS = "CACHE:NEWBACARA:본사:총판관리:총판목록:검색정보들:";
        KEY_CACHEQUERY = "CACHE:NEWBACARA:본사:총판관리:총판목록:검색질문식:";
        KEY_CACHESELINF = "CACHE:NEWBACARA:본사:총판관리:총판목록:선택된정보:";
        KEY_CACHESORT = "CACHE:NEWBACARA:본사:총판관리:총판목록:정돈항:";
        KEY_CACHESORTDIRECTION = "CACHE:NEWBACARA:본사:총판관리:총판목록:정돈방향:";
        KEY_CACHEFILTER = "CACHE:NEWBACARA:본사:총판관리:총판목록:검색인자들:";
        KEY_CACHECURPAGE = "CACHE:NEWBACARA:본사:총판관리:총판목록:현재페지위치:";
        KEY_CACHEFIRSTDATE = "CACHE:NEWBACARA:본사:총판관리:총판목록:첫날자:";
        KEY_CACHELASTDATE = "CACHE:NEWBACARA:본사:총판관리:총판목록:끝날자:";
    ...
    public void BindDataSource()
    {
        ...
        string strQuery = "SELECT *, "
            ...
            + " FROM TBL_Enterprise ent WHERE Class=" + ROLES_CHONGPAN;
    ...
    protected void BindBubonsa()
    {
        ...
        DataSet bbsDS = dm.RunMSelectQuery(new SqlCommand("select * from tbl_enterprise where use_yn=1 and class=3"));
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        검색질문식 = " 1=1 ";
        /*
        if (string.IsNullOrEmpty(tbxPartnerNo.Text.Trim()) == false)
        {
            검색질문식 += " and partner like '%" + tbxPartnerNo.Text.Trim() + "%'";
        } */

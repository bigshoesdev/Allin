<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userbonuscharge.aspx.cs" Inherits="MngMember_usercharge" %>
        ...
        <tr>
            <td align=center colspan=3>
                ...
                <asp:CustomValidator ID="cvResult"
                    runat="server" Display="Dynamic" Text="*"></asp:CustomValidator>
            </td>
        </tr>
        <tr>
            <td align=center colspan=3>

<%@ Page Language="C#" MasterPageFile="회원관리.master" AutoEventWireup="true" CodeFile="업체공지사항목록.aspx.cs"
    Inherits="회원관리_업체공지사항목록" %>
    ...
    <asp:GridView ID="grdList" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:HyperLink ID="lnkEdit" NavigateUrl='<%# "업체공지사항수정.aspx?id=" + Eval("ID").ToString() %>' runat="server" CausesValidation="False"

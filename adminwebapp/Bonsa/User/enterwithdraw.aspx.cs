...
public partial class MngMember_usercharge : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rvMoney.ErrorMessage = "출금가능한 머니는 " + lblMoney.Text + "까지입니다.";
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        try
        {
            long nAddMoney = long.Parse(tbxAddMoney.Text);
            if (nAddMoney <= 0)
            {
                return;
            }
            ...
            string memo = "";
            strQuery = "INSERT INTO TBL_EWithdraw(EnterpriseID, BankInfo, Name, Money, State) ";
            strQuery += "VALUES(@UserID, @BankInfo, @Name, @Money, 2)";
            SqlCommand cmd = new SqlCommand(strQuery);

<%@ Page Language="C#" MasterPageFile="회원관리.master" AutoEventWireup="true" CodeFile="매장목록.aspx.cs" Inherits="회원관리_매장목록" Title="코리아 게임 관리자페이지" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" Runat="Server">
    ...
    <div class='PageToolBar'>
        <table width="100%" border="0" cellpadding="7" cellspacing="1">
            <tr valign="middle">
                ...
                &nbsp;&nbsp;
                 <i class="fa fa-circle-o" ></i>
                총판명:&nbsp;<asp:TextBox ID="tbxChongpanName" runat="server" MaxLength="20"></asp:TextBox>
                </td>
                <td>
    ...
    <asp:GridView ID="grdList" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderText="매장명" SortExpression="Name" >
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:HyperLink ID="lnkEdit" NavigateUrl='<%# "매장등록.aspx?id=" + Eval("ID").ToString() %>' runat="server" CausesValidation="False"

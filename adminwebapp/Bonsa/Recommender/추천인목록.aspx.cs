...
public partial class 회원관리_회원목록 : PageBase
{
    ...
    public void BindDataSource()
    {
        ...
        strQuery += " FROM TBL_UserList U left join TBL_Enterprise E on U.parentid=E.id ";
    ...
    void GridDataBind()
    {
        ...
        grdList.Columns[8].Visible = false; // maejang
        grdList.Columns[9].Visible = false; // maejang

<%@ Page Language="C#" MasterPageFile="게임관리.master" AutoEventWireup="true" CodeFile="올인게임로그.aspx.cs" Inherits="게임로그조회_올인게임로그" Title="코리아 게임 관리자페이지" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Subhead" Runat="Server">
    <link href="../../css/allin/allin.css"  rel="stylesheet"  type="text/css" />
    <style>
        .pokercard {
            background-image: url(/Images/allin/deck.png);
...
<script type="text/javascript">
            ...
            <tr valign="middle">
                ...
                <td width="10%" class="srcTit" nowrap>
                    &nbsp;<i class="fa fa-circle-o" ></i>&nbsp;선택&nbsp; <asp:DropDownList ID="ddlSearchKey" runat="server">
                        ...
                        <asp:ListItem Value="Room">방이름</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td width="15%">
    ...
    <asp:GridView ID="grdList" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Room" NullDisplayText="-" HeaderText="방이름" SortExpression="Room">

...
public partial class 게임관리_가상유저목록 : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        KEY_AUTOREFRESH = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:자동갱신:";
        KEY_CACHEINFOS = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:검색정보들:";
        KEY_CACHEQUERY = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:검색질문식:";
        KEY_CACHESELINF = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:선택된정보:";
        KEY_CACHESORT = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:정돈항:";
        KEY_CACHESORTDIRECTION = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:정돈방향:";
        KEY_CACHEFILTER = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:검색인자들:";
        KEY_CACHECURPAGE = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:현재페지위치:";
        KEY_CACHEFIRSTDATE = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:첫날자:";
        KEY_CACHELASTDATE = "CACHE:NEWBACARA:슈퍼본사:게임관리:고포바관리:가상유저목록:끝날자:";
    ...
    public void BindDataSource()
    {
        ...
        string strQuery = "SELECT * FROM TBL_ROBOTLIST";
    ...
    protected void grdLisTBL_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        // 삭제처리 진행
        DBManager dbManager = new DBManager();
        string strQuery = "DELETE TBL_ROBOTLIST WHERE ID=" + strId;
        SqlCommand cmd = new SqlCommand(strQuery);

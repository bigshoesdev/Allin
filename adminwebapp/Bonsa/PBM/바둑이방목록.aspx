<%@ Page Language="C#" MasterPageFile="게임관리.master" AutoEventWireup="true" CodeFile="바둑이방목록.aspx.cs" Inherits="게임관리_바둑이방목록" Title="코리아 게임 관리자페이지" %>
...
&nbsp;실시간게임방정보</h5>
    ...
    <asp:GridView ID="grdList" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="입장금">
                <ItemTemplate>

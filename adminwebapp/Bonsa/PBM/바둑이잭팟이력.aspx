<%@ Page Language="C#" MasterPageFile="게임관리.master" AutoEventWireup="true" CodeFile="바둑이잭팟이력.aspx.cs" Inherits="게임로그조회_바둑이잭팟이력" Title="코리아 게임 관리자페이지" %>
    ...
    <div class='PageToolBar'>
        <table width="100%" border="0" cellpadding="7" cellspacing="1">
            <tr valign="middle">
                ...
                <td class="cmtTit" width="20%" nowrap="nowrap" align=left>
                    <b><asp:Label ID="lblAllMoney" runat="server"></asp:Label></b>원
                </td>
                <td width="15%" class="srcTit" nowrap>
                    &nbsp;<img src="../../Images/ico_sqr02.gif" width="3" height="3" align="absmiddle">&nbsp; <asp:DropDownList ID="ddlSearchKey" runat="server">

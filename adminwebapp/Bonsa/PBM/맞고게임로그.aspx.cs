...
public partial class 게임로그조회_맞고게임로그 : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        KEY_AUTOREFRESH = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:자동갱신:";
        KEY_CACHEINFOS = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:검색정보들:";
        KEY_CACHEQUERY = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:검색질문식:";
        KEY_CACHESELINF = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:선택된정보:";
        KEY_CACHESORT = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:정돈항:";
        KEY_CACHESORTDIRECTION = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:정돈방향:";
        KEY_CACHEFILTER = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:검색인자들:";
        KEY_CACHECURPAGE = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:현재페지위치:";
        KEY_CACHEFIRSTDATE = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:첫날자:";
        KEY_CACHELASTDATE = "CACHE:MTOURNAMENT:게임로그조회:맞고게임로그:끝날자:";
    ...
    protected void grdList_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        DataSet dsLog = dbManager.RunMatgoSelectQuery(cmd);

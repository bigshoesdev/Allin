<%@ Page Language="C#" MasterPageFile="게임관리.master" AutoEventWireup="true" CodeFile="바둑이게임로그.aspx.cs" Inherits="게임로그조회_바둑이게임로그" Title="코리아 게임 관리자페이지" %>

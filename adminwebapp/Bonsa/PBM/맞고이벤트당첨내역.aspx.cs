...
public partial class 게임로그조회_맞고이벤트당첨내역 : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        KEY_AUTOREFRESH = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:자동갱신:";
        KEY_CACHEINFOS = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:검색정보들:";
        KEY_CACHEQUERY = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:검색질문식:";
        KEY_CACHESELINF = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:선택된정보:";
        KEY_CACHESORT = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:정돈항:";
        KEY_CACHESORTDIRECTION = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:정돈방향:";
        KEY_CACHEFILTER = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:검색인자들:";
        KEY_CACHECURPAGE = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:현재페지위치:";
        KEY_CACHEFIRSTDATE = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:첫날자:";
        KEY_CACHELASTDATE = "CACHE:MTOURNAMENT:게임로그조회:맞고이벤트당첨내역:끝날자:";

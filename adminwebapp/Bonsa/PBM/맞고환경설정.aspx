<%@ Page Language="C#" MasterPageFile="게임관리.master" AutoEventWireup="true" CodeFile="맞고환경설정.aspx.cs" Inherits="게임관리_맞고환경설정" Title="코리아 게임 관리자페이지" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" Runat="Server">
    ...
    <table class="setting_table" cellspacing="0" cellpadding="0" rules="rows" border="1">
        ...
        <tr>
            ...
            <td colspan=3>
                <table border=1 bordercolor=#E7E3E7 cellpadding=0 cellspacing=0 width=100% style="border:none;" height=72px>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="center" class="clsFieldValue">총통</td>
                        <td class="clsFieldValue" align="center">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                                ...
                                ErrorMessage="총통잭팟지급률을 입력하세요" SetFocusOnError="True" 
                                ValidationGroup="register">*</asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator4" runat="server" 
                                ControlToValidate="tbxJackRatio3"  
                                ErrorMessage="총통 잭팟지급률은 수값이여야 합니다." Operator="DataTypeCheck" 
                        ...
                        <td class="clsFieldValue" align="center">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                ...
                                ErrorMessage="총통 잭팟지급머니를 입력하세요" SetFocusOnError="True" 
                                ValidationGroup="register">*</asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator7" runat="server" 
                                ControlToValidate="tbxJackMoney3"  
                                ErrorMessage="총통 잭팟지금머니는 수값이여야 합니다." Operator="DataTypeCheck" 
                                SetFocusOnError="True" Type="Integer" ValidationGroup="register">*</asp:CompareValidator>
                        </td>
                    </tr>
                    <tr style="display:none">

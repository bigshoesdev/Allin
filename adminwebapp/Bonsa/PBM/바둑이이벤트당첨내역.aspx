<%@ Page Language="C#" MasterPageFile="게임관리.master" AutoEventWireup="true" CodeFile="바둑이이벤트당첨내역.aspx.cs" Inherits="게임로그조회_바둑이이벤트당첨내역" %>
    ...
    <div class='PageToolBar'>
        <table width="100%" border="0" cellpadding="7" cellspacing="1">
            <tr valign="middle">
                ...
                <td width="10%" class="srcTit" nowrap="nowrap">
                    &nbsp;<i class="fa fa-circle-o" ></i>
                    &nbsp;&nbsp;당첨액합계
